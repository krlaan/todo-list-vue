...
const data = ref<IResultObject<ITodoCategory>>({})
            ...
            <div class="content">
                <div class="info-panel">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="value">{{ category.categorySort }}</span>
                    </div>
                    <div class="detail-row">
                        <span class="label">Sync Time:</span>
                        <span class="value">{{ formatDate(category.syncDt) }}</span>
                    </div>
                    <div class="detail-row">
                        <span class="label">Tag:</span>
                        <span class="value">{{ category.tag }}</span>
                    </div>

                    <div class="button-group">
                        <button @click="router.push('/Categories')" class="btn btn-secondary">Back</button>
                    </div>
                </div>
            </div>
        </div>
